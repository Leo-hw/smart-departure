...
| 7 | T-007 | 🟡 READY | 알림 스케줄링 재설계 + 배포 (Oracle/GHA) |
| 8 | T-008 | ⬜ BACKLOG | 카카오 Maps 자동차 길찾기 |
...
| T-007 | 알림 스케줄링 재설계 + 배포 | Codex | READY | T-006 |
| T-008 | 카카오 Maps 자동차 길찾기 | Codex | BACKLOG | T-007 |
<!-- QUEUE:END -->
